...
(function (Scratch) {
  ...
  class ProjectFullscreen {
    ...
    switchMode({mode}) {
      if ((this.evaluate()) === (mode === "exitFullscreen") || mode === "toggleFullscreen") document.getElementsByClassName('stage-header_stage-button-icon_3zzFK')[document.getElementsByClassName('stage-header_stage-button-icon_3zzFK').length - 1].click()
    }
    evaluate() {
